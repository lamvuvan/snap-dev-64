...
typedef THash<TInt64, TInt64H, int64> TIntInt64HH;
...
typedef THash<TInt64Pr, TInt64, int64> TIntPrInt64H;
...
typedef THash<TInt64Pr, TFlt, int64> TIntPrFlt64H;
typedef THash<TIntTr, TFlt> TIntTrFltH;
typedef THash<TIntPr, TStr> TIntPrStrH;
typedef THash<TInt64Pr, TStr, int64> TIntPrStr64H;
...
typedef THash<TIntIntPr64Pr, TInt64, int64> TIntIntPrPrInt64H;
typedef THash<TIntIntPrPr, TFlt> TIntIntPrPrFltH;
typedef THash<TIntIntPr64Pr, TFlt, int64> TIntIntPrPrFlt64H;
typedef THash<TIntIntPrPr, TStr> TIntIntPrPrStrH;
typedef THash<TIntIntPr64Pr, TStr, int64> TIntIntPrPrStr64H;
...
typedef THash<TStr, TInt64, int64> TStrInt64H;
typedef THash<TStr, TIntPr> TStrIntPrH;
typedef THash<TStr, TInt64Pr, int64> TStrIntPr64H;
typedef THash<TStr, TIntV> TStrIntVH;
typedef THash<TStr, TInt64V, int64> TStrInt64VH;
