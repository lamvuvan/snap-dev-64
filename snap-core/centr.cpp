...
//Weighted PageRank
    int64
    GetWeightedPageRank(const PNEANet Graph, TIntFlt64H &PRankH, const TStr &Attr, const double &C, const double &Eps,
                        const int64 &MaxIter) {
...
//Event importance 1
    ...
    double GetWeightedFarnessCentr(const PNEANet Graph, const int64 &NId, const TFlt64V &Attr, const bool &Normalized,
                                   const bool &IsDir) {
    ...
    double GetWeightedClosenessCentr(const PNEANet Graph, const int64 &NId, const TFlt64V &Attr, const bool &Normalized,
                                     const bool &IsDir) {
    ...
    void
    GetWeightedBetweennessCentr(const PNEANet Graph, TIntFlt64H &NodeBtwH, TIntPrFlt64H &EdgeBtwH, const TFlt64V &Attr,
                                const double &NodeFrac, const bool &IsDir) {
        TInt64V NIdV;
        Graph->GetNIdV(NIdV);
    ...
    void
    GetWeightedBetweennessCentr(const PNEANet Graph, TIntFlt64H &NodeBtwH, const TFlt64V &Attr, const double &NodeFrac,
                                const bool &IsDir) {
